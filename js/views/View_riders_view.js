...
app.views.View_riders_view = Backbone.View.extend({
    ...
    render: function () {
        ...
        app.menuView.hide_or_show_incen_menu();
        return this;
    },
    dom_ready: function () {
        var self = this;
    ...
    confirm_dropoff: function () {
        ...
        $('#onride').hide();
        var self = this;
        if (app.cuser.get('has_agreement') === 0) {
            app.menuView.$el.find('#driver_incentive_modal').rmodal();
            app.cuser.once('change', app.menuView.hide_or_show_incen_menu);
        }
    },
