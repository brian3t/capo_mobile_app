...
function trackMenu(_track) {
    ga('send', 'event', "Menu", "Click", "Menu: " + _track, {'nonInteraction': 1});
}
function trackButton(_track) {
    ga('send', 'event', "Button", "Click", "Button: " + _track, {'nonInteraction': 1});
}
function trackPage(_track) {
    ga('send', 'pageview', "mwcog.mediabeef.com/" + _track);
}
