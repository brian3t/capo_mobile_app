...
function submit_form_ajax() {
    ...
    $.ajax({
        ...
        complete: function (jqXHR, status) {
            ...
            //2017 11 02 Ignore the ORACLE error
            if (response.statusCode === 0 && response.hasOwnProperty('enrolled') && response.enrolled === true && response.hasOwnProperty('statusDescription') && response.statusDescription.indexOf('Error ORA') !== -1) {
